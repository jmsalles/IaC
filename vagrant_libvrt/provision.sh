...
# instalando o rsync ne
#apt install rsync -y

#Local aonde estao as chave public e privada
KEY_PATH='/vagrant/arquivos'

#Criando o diretorio .ssh para usuario root e vagrant_libvrt
mkdir -p /root/.ssh
mkdir -p /home/vagrant/.ssh
#Copiando as chaves publica e privadas e grantindo o acesso a todos os hos sem senha para o usuario root e vagrant_libvrt
...
#cp $KEY_PATH/key.pub /home/vagrant_libvrt/.ssh/authorized_keys
...
#Instalando o Docker via script  e iniciando o serviço , habilitando na inicialização e adicionando o usuario vagrant_libvrt ao grupo docker
